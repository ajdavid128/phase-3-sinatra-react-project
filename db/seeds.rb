...
Print.create(title: "Phish Gig Poster", year: 2021, edition_size: "1000", category: "concert", image_url: "https://preview.redd.it/wx8bbl4m29v71.jpg?width=640&crop=smart&auto=webp&s=f114eb89c926de80343b0dc3d4401be03f37ace1", artist_id: drew_m.id)
...
lara = Artist.create(name: "Lara - Subterranean Prints", location: "Berlin, Germany", bio: "A strong female artist creating beautiful and dark illustrations and posters for the dark side of music.", artist_photo: "https://www.ox-fanzine.de/mediadb/cache/400x/itv15950.jpg", website_url: "https://www.subterraneanprints.com/", instagram: "@subterranean_prints")
Print.create(title: "Perpetual Owl", year: 2022, edition_size: "limited", category: "concert poster", image_url: "https://www.subterraneanprints.com/media/image/product/4/md/perpetual-owl-2.jpg", artist_id: lara.id)
Print.create(title: "Afsky", year: 2022, edition_size: "limited", category: "concert poster", image_url: "https://www.subterraneanprints.com/media/image/product/12/lg/afsky.jpg", artist_id: lara.id)
Print.create(title: "Toxic Thoughts", year: 2022, edition_size: "limited", category: "fine art print", image_url: "https://www.subterraneanprints.com/media/image/product/11/lg/toxic-thoughts.jpg", artist_id: lara.id)
